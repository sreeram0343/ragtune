...
def test_organization_and_invitation_flow():
    ...
    _, owner, _ = identity_svc.register_user("owner@acme.com", "Password123!", "Acme Owner")
    _, invitee, _ = identity_svc.register_user("invitee@acme.com", "Password123!", "Acme Invitee")
