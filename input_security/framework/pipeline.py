...
from input_security.framework.stage import (
    BaseSecurityStage, StageResult, SecurityRequestContainer, EnrichedSecurityRequest
)
...
from input_security.stages.s5_normalization_sanitization import NormalizationSanitizationStage
from input_security.stages.s6_prompt_jailbreak_defense import PromptJailbreakDefenseStage
...
class InputSecurityPipeline:
    ...
    def process_request(self, container: SecurityRequestContainer) -> EnrichedSecurityRequest:
        """
