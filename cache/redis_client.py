...
class EnterpriseCacheManager:
    ...
    def set(self, cache_key: str, value: Dict[str, Any], ttl_seconds: int = settings.CACHE_TTL_SECONDS):
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "cached_items_count": len(self.memory_cache) if not self.use_redis else "managed_by_redis"
        }
