...
def run_worker():
    ...
    logger.info("Worker daemon ready. Subscribed to task queues [default, ai_eval, indexing].")
    ...
    while True:
        try:
            ...
            task_count += 1
            if task_count % 6 == 0:
                logger.info(f"Heartbeat: Worker operational. Processed batch {task_count} queued tasks.")
