...
from typing import List, Tuple, Dict, Any, Optional
from storage.vector_store import HybridVectorStore
from storage.document_processor import DocumentProcessor, DocumentChunk
from config.settings import settings


class HybridSearchEngine:
    def __init__(self, vector_store: HybridVectorStore, docs_dir: str = "demo_data/sample_documents"):
