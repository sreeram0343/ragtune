...
ORG_ROLE_PERMISSIONS: Dict[OrgRole, Set[Permission]] = {
    OrgRole.OWNER: {
        Permission.ORG_READ, Permission.ORG_WRITE, Permission.ORG_DELETE, Permission.ORG_MANAGE_MEMBERS,
        Permission.WORKSPACE_READ, Permission.WORKSPACE_WRITE, Permission.WORKSPACE_DELETE, Permission.WORKSPACE_MANAGE_MEMBERS,
        Permission.PROJECT_READ, Permission.PROJECT_WRITE, Permission.PROJECT_DELETE,
        Permission.USER_MANAGE, Permission.USER_SUSPEND, Permission.SECURITY_ADMIN, Permission.AUDIT_READ,
    },
    OrgRole.ADMIN: {
