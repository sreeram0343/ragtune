...
class CreateOrgRequest(BaseModel):
    ...
    domain: str | None = Field(None, description="Optional corporate domain")
...
class CreateInvitationRequest(BaseModel):
    ...
    role: str = Field(
        "MEMBER", description="Role to grant: OWNER, ADMIN, MEMBER, GUEST"
    )
    workspace_id: str | None = Field(
        None, description="Optional specific workspace ID"
    )
